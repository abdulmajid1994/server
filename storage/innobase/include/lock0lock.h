...
struct LockGuard
{
  ...
  /** @return the first lock of the hash array cell */
  lock_t *lock() const { return static_cast<lock_t*>(cell_->node); }
...
struct LockMultiGuard
{
  ...
  /** @return the first lock of the first hash array cell */
  lock_t *lock1() const { return static_cast<lock_t*>(cell1_->node); }
  /** @return the first lock of the second hash array cell */
  lock_t *lock2() const { return static_cast<lock_t*>(cell2_->node); }
